...
spark.sql(f"DROP DATABASE IF EXISTS {sa_wind_turbine_load_prediction} CASCADE")
spark.sql(f"CREATE DATABASE {sa_wind_turbine_load_prediction}")
spark.sql(f"USE {sa_wind_turbine_load_prediction}")
